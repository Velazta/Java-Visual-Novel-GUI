...
public class Ending4 extends JPanel {
    ...
    private String[] storyTexts = {
            ...
            "Titoti segera mencari jalan keluar dari jurang dengan tubuh yang penuh luka dan racun. Setelah terlihat suatu jalan, ia terus berjalan meskipun dalam kondisi lemah.",
            "Sayang sekali, perjalanan Titoti harus terhenti karena kesadarannya hilang akibat bisa ular yang sudah menyebar di tubuhnya."
    };
    ...
    private void initializeUI() {
        ...
        effect.setOnCompleteListener(() -> {
            if (currentTextIndex == storyTexts.length - 1) {
                // Tampilkan BAD ENDING dan tombol EXIT setelah narasi selesai
